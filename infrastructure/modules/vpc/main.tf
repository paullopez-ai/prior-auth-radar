...
# Private subnets host the ECS tasks and Aurora.
...
resource "aws_security_group" "frontend" {
  ...
  description = "Frontend ECS — ingress from ALB on 3000"
  vpc_id      = aws_vpc.this.id
...
resource "aws_security_group" "backend" {
  ...
  description = "Backend ECS — ingress from ALB and frontend on 8000"
  vpc_id      = aws_vpc.this.id
...
resource "aws_security_group" "aurora" {
  ...
  description = "Aurora — ingress from backend ECS on 5432"
  vpc_id      = aws_vpc.this.id
